        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li><a href="about.php"class="nav-link active">Sobre Nosotros</a></li>
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <span class="text-white"><strong>Sobre Nosotros</strong></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/465918701" class="block__96788">
              <span class="play-icon"><span class="icon-play"></span></span>
              <div>
              <img src="images/ele.jpeg" alt="Image" class="img-fluid img-shadow">
            </div>
            </a>
          </div>
          <div class="col-lg-5 ml-auto">
            &nbsp;
            <h2 class="section-title mb-3">PeguitasYa Para Todos</h2>
            <p class="lead">PeguitasYa es una idea que nació por la escasez de puestos de trabajo en la ciudad de Valdivia, por ello será un producto enfocado netamente en la búsqueda y ofrecimiento laboral por parte de empresas de toda índole y/o personas generales </p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            <h2 class="section-title mb-3">PeguitasYa para trabajadores</h2>
            <p class="lead">El nivel de empleabilidad en chile se ha visto fuertemente afectado por dos grandes acontecimientos ocurridos en los últimos 12 meses, el “Estallido Social” que dio inicio el 18 de octubre del año 2019 en donde una gran cantidad de pequeñas y medianas empresas, como también emprendimientos se vieron afectados de manera negativa producto a los daños colaterales del movimiento social. El segundo evento sufrido a nivel mundial al cual comenzó a afectar a nuestro país en marzo del 2020 fue la llegada del virus COVID-19, trajo consigo un importante aumento en la cesantía producto de las medidas tomadas para poder enfrentar la pandemia.</p>
          </div>
        </div>
      </div>
    </section>
