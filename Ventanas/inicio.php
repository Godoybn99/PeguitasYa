...
<head>
    <title>PeguitasYa &mdash; Login</title>
    <meta charset="utf-8">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="has-children">
                <a href="services.html">Paginas</a>
                <ul class="dropdown">
            ...
            <form action="php/login.php" class="p-4 border rounded" method="POST">
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="txtRut" class="form-control" placeholder="Ingrese su rut">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Usuario</label>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="password" name="txtPas" class="form-control" placeholder="contraseña">
                </div>
              </div>
